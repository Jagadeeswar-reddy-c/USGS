...
# global datasetName,lat1,lon1,lat2,lon2
...
def main(username,password,datasetName, lat1, lon1, lat2, lon2 , start , end , dst_file , file):
    username = username
    password = password
    ...
    spatialFilter = {'filterType': "mbr",
                     'lowerLeft': {'latitude': lat1, 'longitude': lon1},
                     'upperRight': {'latitude': lat2, 'longitude': lon2}}

    temporalFilter = {'start': start, 'end': end }
        ...
        if scenes['recordsReturned'] > 0:
            ...
            if downloads:
                ...
                if requestResults['preparingDownloads'] != None and len(requestResults['preparingDownloads']) > 0:
                    ...
                    #file = open(r"C:\Users\ravindra\Desktop\usgs\textdata.txt", "a")
                    list1 = []
                    ...
                    for i in range(0, len(list1)):
                        link_download.download(list1[i], dst_file, file)
